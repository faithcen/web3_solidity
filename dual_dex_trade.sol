...
contract DualDexSwap2 is Ownable {
	...
	function dualDexTrade(address _router1, address _router2, address _token1, address _token2, uint256 _amount) external onlyOwner returns (uint, uint) {
	...
	function recoverEth() external onlyOwner {
        require(address(this).balance > 0, "There is no ETH!!");
